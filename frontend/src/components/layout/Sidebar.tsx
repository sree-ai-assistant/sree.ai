          ...
          <div className={styles.utilitiesSection}>
            {isCollapsed ? (
              <div className={styles.utilitiesCollapsed}>
                ...
                <button className={styles.miniIconBtn} onClick={() => handleNavigate('/feature-request')} title="Feature Request">
                  <Lightbulb size={18} />
                </button>
              ...
              <div className={styles.utilitiesVertical}>
                ...
                <button className={styles.utilityItem} onClick={() => handleNavigate('/feature-request')}>
                  <Lightbulb size={18} />
