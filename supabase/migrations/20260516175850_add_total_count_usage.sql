-- Migration: Add Total Count to Usage Tracking
-- Description: Adds a total_count column to usage_tracking to separately track the all-time usage of each tool type.
  ...
  IF v_all_allowed THEN
    ...
    LOOP
      ...
      SET 
        ...
        total_count = total_count + v_request.amount,
